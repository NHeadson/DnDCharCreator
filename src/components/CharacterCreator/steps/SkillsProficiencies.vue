          ...
          <v-card class="skill-card pa-4 text-center" color="error" variant="outlined">
            ...
            <div class="mt-4 text-left">
              ...
              <div class="d-flex align-center">
                <v-icon class="mr-1" color="info" size="small">mdi-information</v-icon>
          ...
          <div v-if="hasClassSkillChoices">
            ...
            <div v-if="isClassSkillSelectionComplete" class="ml-8">
              <div class="d-flex align-center ga-3 mb-3">
                ...
                <v-btn color="primary" prepend-icon="mdi-refresh" size="small" variant="outlined" @click="resetClassSkillSelection">Change Selection</v-btn>
              </div>
            </div>
