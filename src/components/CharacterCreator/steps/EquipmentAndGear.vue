<template>
    ...
    <v-card-text>
        ...
        <v-card-text>
          <v-radio-group v-model="equipmentMethod" hide-details>
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-card class="equipment-method-card pa-4 cursor-pointer h-100"
                  :color="equipmentMethod === 'class' ? 'primary' : 'white'"
                  :variant="equipmentMethod === 'class' ? 'outlined' : 'outlined'" @click="equipmentMethod = 'class'">
                  ...
                  <div v-if="hasClassEquipment" class="class-equipment-preview">
                    ...
                    <v-btn class="mt-2 pa-0" color="primary" size="x-small" variant="text"
              ...
              <v-col cols="12" md="6">
                <v-card class="equipment-method-card pa-4 cursor-pointer h-100"
                  :color="equipmentMethod === 'gold' ? 'primary' : 'white'"
                  :variant="equipmentMethod === 'gold' ? 'outlined' : 'outlined'" @click="equipmentMethod = 'gold'">
                  <div class="d-flex align-center mb-2">
                  ...
                  <div class="gold-preview">
                    ...
                    <v-btn class="mt-1 pa-0" color="primary" size="x-small" variant="text"
                    ...
                    <v-expand-transition>
                      <div v-if="showGoldAdvantages" class="mt-2">
                        <div class="text-caption">
                          <div class="mb-1">
                            <v-icon class="mr-1" color="success" size="x-small">mdi-check</v-icon>
                          ...
                          <div class="mb-1">
                            <v-icon class="mr-1" color="warning" size="x-small">mdi-alert</v-icon>
          ...
          <v-alert v-if="equipmentMethod === 'gold'" class="mt-4" type="info" variant="tonal">
      ...
      <v-card class="mb-6" variant="outlined">
        <v-card-title class="d-flex align-center">
          <v-icon class="me-3" color="surface-variant" size="large">mdi-plus-circle-outline</v-icon>
          <div>
            <div class="text-h5">
        ...
        <!-- Contextual Alert -->
        <v-alert v-if="equipmentMethod === 'class'" class="ma-4 mb-0" type="success" variant="tonal">
            ...
            <v-col class="d-flex" cols="12" lg="6">
              <v-card class="flex-grow-1" variant="outlined">
                <v-card-title class="d-flex align-center justify-space-between pa-4"
                  ...
                  <v-btn v-if="equipmentMethod !== 'class'" color="red" prepend-icon="mdi-plus" size="small"
                    variant="elevated" @click="addWeaponDialog = true">
                    Add Weapon
                  </v-btn>
                </v-card-title>

                <v-card-text class="pa-2">
                  <v-list v-if="allWeapons.length" class="py-0" density="comfortable">
                    <template v-for="(weapon, index) in allWeapons" :key="`weapon-${index}`">
                      <v-list-item class="px-4">
                        <template #prepend>
                          <v-avatar :color="weapon.custom ? 'red-lighten-1' : 'red-darken-2'" size="small">
                        ...
                        <v-list-item-title class="text-truncate"
                          ...
                          {{ weapon.name }}
                          <v-chip v-if="!weapon.custom && detectEquipmentChoices(weapon.name)" class="ml-2"
                            :color="isEquipmentChoiceComplete(weapon.name) ? 'success' : 'warning'" size="x-small"
                            :variant="isEquipmentChoiceComplete(weapon.name) ? 'elevated' : 'outlined'">
                          ...
                          <div v-if="isEquipmentChoiceComplete(weapon.name)">
                            ...
                            <div class="d-flex flex-wrap ga-2 mb-3">
                              <v-chip
                                ...
                                :key="choice" color="success" size="x-small" variant="tonal">
                                {{ choice }}
                              </v-chip>
                            </div>
                            ...
                            <div v-if="detectEquipmentChoices(weapon.name).isMultiStage">
                              ...
                              <div v-if="!multiStageChoices[detectEquipmentChoices(weapon.name).type]?.category"
                                ...
                                <v-chip
                                  ...
                                  :key="option" clickable color="primary" size="small" variant="outlined"
                              ...
                              <div v-if="multiStageChoices[detectEquipmentChoices(weapon.name).type]?.category">
                                ...
                                <div class="d-flex flex-wrap ga-2 mb-3">
                                  <v-chip
                                    ...
                                    :key="option" clickable :color="getEquipmentDuplicateState(option, detectEquipmentChoices(weapon.name).type)
                                      ? 'error'
                                    ...
                                    size="x-small" :variant="getEquipmentDuplicateState(option, detectEquipmentChoices(weapon.name).type)
                                      ? 'tonal'
                                      : (equipmentChoices[detectEquipmentChoices(weapon.name).type] || []).includes(option)
                                        ? 'elevated'
                                        : 'outlined'"
            ...
            <v-col class="d-flex" cols="12" lg="6">
              <v-card class="flex-grow-1" variant="outlined">
                <v-card-title class="d-flex align-center justify-space-between pa-4"
                  ...
                  <v-btn v-if="equipmentMethod !== 'class'" color="blue" prepend-icon="mdi-plus" size="small"
                    variant="elevated" @click="addArmorDialog = true">
                    Add Armor
                  </v-btn>
                </v-card-title>

                <v-card-text class="pa-2">
                  <v-list v-if="allArmor.length" class="py-0" density="comfortable">
                    <template v-for="(armor, index) in allArmor" :key="`armor-${index}`">
                      <v-list-item class="px-4">
                        <template #prepend>
                          <v-avatar :color="armor.custom ? 'blue-lighten-1' : 'blue-darken-2'" size="small">
                        ...
                        <v-list-item-title class="text-truncate"
                          ...
                          {{ armor.name }}
                          <v-chip v-if="!armor.custom && detectEquipmentChoices(armor.name)" class="ml-2"
                            :color="isEquipmentChoiceComplete(armor.name) ? 'success' : 'warning'" size="x-small"
                            :variant="isEquipmentChoiceComplete(armor.name) ? 'elevated' : 'outlined'">
                          ...
                          <div v-else>
                            ...
                            <div class="d-flex flex-wrap ga-2 mb-3">
                              <v-chip
                                ...
                                :key="option" clickable :color="getEquipmentDuplicateState(option, detectEquipmentChoices(armor.name).type)
                                  ? 'error'
                                ...
                                size="x-small" :variant="getEquipmentDuplicateState(option, detectEquipmentChoices(armor.name).type)
                                  ? 'tonal'
                                  : (equipmentChoices[detectEquipmentChoices(armor.name).type] || []).includes(option)
                                    ? 'elevated'
                                    : 'outlined'"
            ...
            <v-col class="d-flex" cols="12" lg="6">
              <v-card class="flex-grow-1" variant="outlined">
                <v-card-title class="d-flex align-center justify-space-between pa-4"
                  ...
                  <v-btn v-if="equipmentMethod !== 'class'" color="green" prepend-icon="mdi-plus" size="small"
                    variant="elevated" @click="addToolDialog = true">
                    Add Tool
                  </v-btn>
                </v-card-title>
                ...
                <v-card-text class="pa-2">
                  <template v-if="allTools.length">
                    <template v-for="(tool, index) in allTools" :key="`tool-${index}`">
                      ...
                      <v-list class="py-0" density="comfortable">
                        <v-list-item class="px-4">
                          <template #prepend>
                            <v-avatar :color="tool.custom ? 'green-lighten-1' : 'green-darken-2'" size="small">
                          ...
                          <div class="w-100">
                            <v-list-item-title class="text-truncate"
                              ...
                              {{ tool.name }}
                              <v-chip v-if="!tool.custom && detectEquipmentChoices(tool.name)" class="ml-2"
                                :color="isEquipmentChoiceComplete(tool.name) ? 'success' : 'warning'" size="x-small"
                                :variant="isEquipmentChoiceComplete(tool.name) ? 'elevated' : 'outlined'">
                              ...
                              <div v-if="multiStageChoices[detectEquipmentChoices(tool.name).type]?.category">
                                ...
                                <div class="d-flex flex-wrap ga-2 mb-3">
                                  <v-chip
                                    ...
                                    :key="option" clickable :color="getEquipmentDuplicateState(option, detectEquipmentChoices(tool.name).type)
                                      ? 'error'
                                    ...
                                    size="x-small" :variant="getEquipmentDuplicateState(option, detectEquipmentChoices(tool.name).type)
                                      ? 'tonal'
                                      : (equipmentChoices[detectEquipmentChoices(tool.name).type] || []).includes(option)
                                        ? 'elevated'
                                        : 'outlined'"
                  ...
                  <div v-if="!allTools.length" class="pa-6 text-center">
                    <v-icon color="medium-emphasis" size="large">mdi-tools</v-icon>
            ...
            <v-col class="d-flex" cols="12" lg="6">
              <v-card class="flex-grow-1" variant="outlined">
                <v-card-title class="d-flex align-center justify-space-between pa-4"
                  ...
                  <v-btn v-if="equipmentMethod !== 'class'" color="orange" prepend-icon="mdi-plus" size="small"
                    variant="elevated" @click="addGearDialog = true">
                    Add Gear
                  </v-btn>
                </v-card-title>
                ...
                <v-card-text class="pa-2">
                  <template v-if="allGear.length">
                    <template v-for="(item, index) in allGear" :key="`gear-${index}`">
                      ...
                      <v-list class="py-0" density="comfortable">
                        <v-list-item class="px-4">
                          <template #prepend>
                            <v-avatar :color="item.custom ? 'orange-lighten-1' : 'orange-darken-2'" size="small">
                          ...
                          <div class="w-100">
                            <v-list-item-title class="text-truncate"
                              ...
                              {{ item.name }}
                              <v-chip v-if="!item.custom && detectEquipmentChoices(item.name)" class="ml-2"
                                :color="isEquipmentChoiceComplete(item.name) ? 'success' : 'warning'" size="x-small"
                                :variant="isEquipmentChoiceComplete(item.name) ? 'elevated' : 'outlined'">
                          ...
                          <div v-else>
                            ...
                            <div class="d-flex flex-wrap ga-2 mb-3">
                              <v-chip
                                ...
                                :key="option" clickable :color="getEquipmentDuplicateState(option, detectEquipmentChoices(item.name).type)
                                  ? 'error'
                                ...
                                size="x-small" :variant="getEquipmentDuplicateState(option, detectEquipmentChoices(item.name).type)
                                  ? 'tonal'
                                  : (equipmentChoices[detectEquipmentChoices(item.name).type] || []).includes(option)
                                    ? 'elevated'
                                    : 'outlined'"
                  ...
                  <div v-else class="pa-6 text-center">
                    <v-icon color="medium-emphasis" size="large">mdi-bag-personal-off</v-icon>
      ...
      <v-card class="mt-6" variant="outlined">
        ...
        <v-card-text>
          ...
          <div v-if="equipmentMethod === 'gold'" class="text-center">
            <v-tooltip location="top" text="Gold pieces you have left to spend on additional equipment">
              <template #activator="{ props }">
  ...
  <v-dialog v-model="addWeaponDialog" max-width="600">
    <v-card>
          ...
          <v-tabs-window-item value="api">
            ...
            <div v-else class="equipment-chips">
              ...
              <div class="d-flex flex-wrap ga-2">
                <v-chip v-for="weapon in weaponOptions.slice(0, 30)" :key="weapon.id" class="weapon-chip" clickable
      ...
      <v-card-actions>
        ...
        <v-btn v-if="weaponTab === 'api'" color="primary" :disabled="!selectedWeapon || !canAfford(selectedWeapon)"
  ...
  <v-dialog v-model="addArmorDialog" max-width="600">
    <v-card>
        ...
        <v-tabs-window v-model="armorTab" class="mt-4">
          ...
          <v-tabs-window-item value="api">
            ...
            <div v-else class="equipment-chips">
              ...
              <div class="d-flex flex-wrap ga-2">
                <v-chip v-for="armor in armorOptions.slice(0, 30)" :key="armor.id" class="armor-chip" clickable
      ...
      <v-card-actions>
        ...
        <v-btn v-if="armorTab === 'api'" color="primary" :disabled="!selectedArmor || !canAfford(selectedArmor)"
  ...
  <v-dialog v-model="addToolDialog" max-width="600">
    <v-card>
        ...
        <v-tabs-window v-model="toolTab" class="mt-4">
          ...
          <v-tabs-window-item value="api">
            ...
            <div v-else class="equipment-chips">
              ...
              <div class="d-flex flex-wrap ga-2">
                <v-chip v-for="tool in toolOptions.slice(0, 30)" :key="tool.id" class="tool-chip" clickable
      ...
      <v-card-actions>
        ...
        <v-btn v-if="toolTab === 'api'" color="primary" :disabled="!selectedTool || !canAfford(selectedTool)"
  ...
  <v-dialog v-model="addGearDialog" max-width="600">
    <v-card>
        ...
        <v-tabs-window v-model="gearTab" class="mt-4">
          ...
          <v-tabs-window-item value="api">
            ...
            <div v-else class="equipment-chips">
              ...
              <div class="d-flex flex-wrap ga-2">
                <v-chip v-for="gear in gearOptions.slice(0, 30)" :key="gear.id" class="gear-chip" clickable
      ...
      <v-card-actions>
        ...
        <v-btn v-if="gearTab === 'api'" color="primary" :disabled="!selectedGear || !canAfford(selectedGear)"
  ...
  <v-dialog v-model="choiceDialogs.musicalInstruments" max-width="600">
    <v-card>
      <v-card-title class="d-flex align-center">
        <v-icon class="mr-3" color="green">mdi-music</v-icon>
      ...
      <v-card-text>
        ...
        <div class="d-flex flex-wrap ga-2">
          <v-chip v-for="instrument in availableChoices.musicalInstruments" :key="instrument" clickable
            ...
            @click="addEquipmentChoice('musicalInstruments', instrument)">
            {{ instrument }}
          </v-chip>
        </div>
      </v-card-text>
  ...
  <v-dialog v-model="choiceDialogs.gamingSets" max-width="600">
    <v-card>
      <v-card-title class="d-flex align-center">
        <v-icon class="mr-3" color="green">mdi-dice-multiple</v-icon>
        Choose Gaming Set
      </v-card-title>
      <v-card-text>
        <div class="text-body-2 mb-4">Select a gaming set:</div>
        <div class="d-flex flex-wrap ga-2">
          <v-chip v-for="gamingSet in availableChoices.gamingSets" :key="gamingSet" clickable
            :color="(equipmentChoices.gamingSets || []).includes(gamingSet) ? 'green' : 'default'"
            :variant="(equipmentChoices.gamingSets || []).includes(gamingSet) ? 'elevated' : 'outlined'"
  ...
  <v-dialog v-model="choiceDialogs.artisanTools" max-width="600">
    <v-card>
      <v-card-title class="d-flex align-center">
        <v-icon class="mr-3" color="green">mdi-tools</v-icon>
      ...
      <v-card-text>
        ...
        <div class="d-flex flex-wrap ga-2">
          <v-chip v-for="tool in availableChoices.artisanTools" :key="tool" clickable
            :color="(equipmentChoices.artisanTools || []).includes(tool) ? 'green' : 'default'"
            :variant="(equipmentChoices.artisanTools || []).includes(tool) ? 'elevated' : 'outlined'"
  ...
  <v-dialog v-model="choiceDialogs.vehicles" max-width="600">
    <v-card>
      <v-card-title class="d-flex align-center">
        <v-icon class="mr-3" color="green">mdi-car</v-icon>
      ...
      <v-card-text>
        ...
        <div class="d-flex flex-wrap ga-2">
          <v-chip v-for="vehicle in availableChoices.vehicles" :key="vehicle" clickable :color="getEquipmentDuplicateState(vehicle).isDuplicate ? 'error' :
            (equipmentChoices.vehicles || []).includes(vehicle) ? 'success' : 'default'"
            :disabled="getEquipmentDuplicateState(vehicle).isDuplicate" :variant="getEquipmentDuplicateState(vehicle).isDuplicate ? 'tonal' :
