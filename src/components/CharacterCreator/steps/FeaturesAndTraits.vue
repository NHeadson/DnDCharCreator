    ...
    <v-card-text>
            ...
            <v-row>
              ...
              <v-col cols="12" md="8">
                <div class="d-flex flex-wrap align-center ga-2 mb-3">
                  ...
                  <v-tooltip
                    v-if="character.speciesDetails.darkvision"
                    location="top"
                  ...
                  <v-tooltip
                    v-if="character.speciesDetails.damageResistance"
                    location="top"
          ...
          <div class="mb-4">
            <div v-if="speciesTraitsWithDetails.length">
              ...
              <div class="trait-accordion">
                <v-card
                  v-for="(trait, index) in speciesTraitsWithDetails"
                  :key="trait.name || trait.index"
                  class="mb-2"
                  variant="outlined"
                >
                  <v-card-title
                    class="pa-3 cursor-pointer trait-header"
                    :class="{ 'trait-expanded': expandedTraits[index] }"
                    @click="toggleTrait(index)"
                  >
        ...
        <v-card-text>
          ...
          <div v-if="character.classDetails.features?.length" class="mb-4">
            ...
            <div class="class-features-accordion">
              <v-card
                v-for="(feature, index) in character.classDetails.features"
                :key="feature.name || feature.index"
                class="mb-2"
                variant="outlined"
              >
                <v-card-title
                  class="pa-3 cursor-pointer feature-header"
                  :class="{ 'feature-expanded': expandedClassFeatures[index] }"
                  @click="toggleClassFeature(index)"
                >
              ...
              <div v-if="character.backgroundDetails.skill_proficiencies?.length" class="mb-4">
                ...
                <v-chip-group>
                  <v-tooltip
                    ...
                    :key="skill.name"
                    location="top"
                    :text="`Your background grants proficiency in ${skill.name}`"
                  >
                    <template #activator="{ props }">
      ...
      <v-card class="mb-6" variant="outlined">
        ...
        <v-card-text>
          ...
          <div
            v-if="!hasFightingStyle && !hasExpertise && !isWarlock && !isDruid && !isCleric"
            ...
            <v-col v-if="hasFightingStyle" cols="12">
              <v-card class="feature-choice-card" color="red-lighten-5" variant="tonal">
                <v-card-title class="d-flex align-center text-h6">
                  ...
                  <v-spacer />
                  <v-chip
                    :color="hasFightingStyle && !selectedFightingStyle ? 'error' : 'red'"
                    size="small"
                    variant="outlined"
                  >
            ...
            <v-col v-if="hasExpertise" cols="12">
              <v-card class="feature-choice-card" color="yellow-lighten-5" variant="tonal">
                <v-card-title class="d-flex align-center text-h6">
                  ...
                  <v-spacer />
                  <v-chip
                    :color="selectedExpertiseSkills.length < expertiseChoices ? 'error' : 'yellow-darken-2'"
                    size="small"
                    variant="outlined"
                  >
                  ...
                  <div class="expertise-skills-grid">
                    ...
                    >
                      <div class="skill-category-header">
                        <v-icon
                          class="me-2"
                          :color="isImportantAbility('Strength') ? 'red-darken-1' : 'red-darken-3'"
                          size="small"
                        >mdi-arm-flex</v-icon>
                        <span class="text-subtitle-2 font-weight-bold">Strength</span>
                        <v-chip
                          v-if="isImportantAbility('Strength')"
                          class="ml-2"
                          color="primary"
                          size="x-small"
                          variant="outlined"
                      ...
                      <div class="skill-chips">
                        ...
                        >
                          <template #activator="{ props }">
                            <v-chip
                              v-bind="props"
                              :color="selectedExpertiseSkills.includes(skill)
                    ...
                    >
                      <div class="skill-category-header">
                        ...
                        <v-chip
                          v-if="isImportantAbility('Dexterity')"
                          class="ml-2"
                          color="primary"
                          size="x-small"
                          variant="outlined"
                      ...
                      <div class="skill-chips">
                        <v-tooltip
                          v-for="skill in dexteritySkills"
                          :key="skill"
                          location="top"
                    ...
                    <!-- Intelligence Skills -->
                    <div
                      v-if="intelligenceSkills.length > 0"
                      class="skill-category"
                    ...
                    >
                      <div class="skill-category-header">
                        ...
                        <v-chip
                          v-if="isImportantAbility('Intelligence')"
                          class="ml-2"
                          color="primary"
                          size="x-small"
                          variant="outlined"
                      ...
                      <div class="skill-chips">
                        <v-tooltip
                          v-for="skill in intelligenceSkills"
                          :key="skill"
                          location="top"
                    ...
                    >
                      <div class="skill-category-header">
                        <v-icon
                          class="me-2"
                          :color="isImportantAbility('Wisdom') ? 'teal-darken-1' : 'teal-darken-3'"
                          size="small"
                        >mdi-eye</v-icon>
                        <span class="text-subtitle-2 font-weight-bold">Wisdom</span>
                        <v-chip
                          v-if="isImportantAbility('Wisdom')"
                          class="ml-2"
                          color="primary"
                          size="x-small"
                          variant="outlined"
                    ...
                    >
                      <div class="skill-category-header">
                        ...
                        <v-chip
                          v-if="isImportantAbility('Charisma')"
                          class="ml-2"
                          color="primary"
                          size="x-small"
                          variant="outlined"
            ...
            <v-window v-model="spellTab">
              ...
              <v-window-item v-if="cantripsKnown > 0" :value="0">
                ...
                <v-list v-if="selectedCantrips.length">
                  <v-list-item
                    v-for="spell in selectedCantripsDetails"
                    :key="spell.index"
                    :active="selectedCantripDetail === spell.index"
                    @click="selectedCantripDetail = spell.index"
                  >
              ...
              <v-window-item v-if="spellsKnown > 0" :value="1">
                ...
                <v-list v-if="selectedSpells.length">
                  <v-list-item
                    v-for="spell in selectedSpellsDetails"
                    :key="spell.index"
                    :active="selectedSpellDetail === spell.index"
                    @click="selectedSpellDetail = spell.index"
                  >
                    <v-list-item-title>{{ spell.name }}</v-list-item-title>
                  </v-list-item>
                </v-list>
