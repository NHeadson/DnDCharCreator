          ...
          <v-card-text class="pt-3 pb-2">
            ...
            <div class="mb-3 ms-6">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  ...
                  <v-tooltip
                    v-if="selectedClassInfo.savingThrows && selectedClassInfo.savingThrows.length"
                    location="top"
                    text="Ability scores this class is proficient in for saving throws"
                  >
                    <template #activator="{ props }">
            ...
            <div v-if="selectedClassInfo.weaponProficiencies?.length" class="mb-3 ms-6">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  <v-tooltip
                    v-for="wp in selectedClassInfo.weaponProficiencies"
                    :key="'wp-' + wp"
                    location="top"
            ...
            <div v-if="selectedClassInfo.armorProficiencies?.length" class="mb-3 ms-6">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  <v-tooltip
                    v-for="ap in selectedClassInfo.armorProficiencies"
                    :key="'ap-' + ap"
                    location="top"
            ...
            <div v-if="selectedClassInfo.toolProficiencies?.length" class="mb-3 ms-6">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  <v-tooltip
                    v-for="tp in selectedClassInfo.toolProficiencies"
                    :key="'tp-' + tp"
                    location="top"
            ...
            <div v-if="selectedClassInfo?.skillProficiencies?.from?.length" class="mb-3 ms-6">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  <v-tooltip
                    v-for="sk in selectedClassInfo.skillProficiencies.from"
                    :key="'sk-' + sk"
                    location="top"
            ...
            >
              ...
              <div class="ms-3">
                <v-chip
                  v-if="selectedClassInfo.spellcasting.ability"
                  class="me-2 mb-1"
                  color="deep-purple"
                  size="x-small"
                  variant="flat"
                ...
                <v-chip
                  v-if="selectedClassInfo.spellcasting.cantripsKnown"
                  class="me-2 mb-1"
                  color="deep-purple"
                  size="x-small"
                  variant="flat"
                ...
                <v-chip
                  v-if="selectedClassInfo.spellcasting.spellsKnown"
                  class="me-2 mb-1"
                  color="deep-purple"
                  size="x-small"
                  variant="flat"
                ...
                <v-chip
                  v-if="selectedClassInfo.spellcasting.spellSlots"
                  class="me-2 mb-1"
                  color="deep-purple"
                  size="x-small"
                  variant="flat"
                ...
                <div
                  v-if="selectedClassInfo.spellcasting.info && selectedClassInfo.spellcasting.info.length"
                  class="mt-2"
                >
                  <v-expansion-panels class="spellcasting-info-panels" elevation="0" multiple>
                    <v-expansion-panel
                      v-for="(info, idx) in selectedClassInfo.spellcasting.info"
                      :key="'spellinfo-' + idx"
                    >
            ...
            <!-- Level 1 Features -->
            <div
              v-if="selectedClassInfo && selectedClassInfo.features && selectedClassInfo.features.length"
              class="mb-3 ms-6"
            >
              <div class="d-flex align-center mb-1">
                      ...
                      >
                        ...
                        <div v-if="feature.feature_specific.enemy_type_options">
                          <div class="feature-choice-chips">
                            <v-chip
                              v-for="type in feature.feature_specific.enemy_type_options.from.options"
                              :key="'enemy-' + type"
                              class="ms-3 me-1 mb-1"
                              color="amber"
                              size="small"
                            >{{ type
                            }}</v-chip>
                        ...
                        <div v-if="feature.feature_specific.terrain_type_options">
                          <div class="feature-choice-chips">
                            <v-chip
                              v-for="type in feature.feature_specific.terrain_type_options.from.options"
                              :key="'terrain-' + type"
                              class="ms-3 me-1 mb-1"
                              color="teal"
                              size="small"
            ...
            <!-- Starting Equipment -->
            <div
              v-if="selectedClassInfo.startingEquipment && selectedClassInfo.startingEquipment.length"
              class="mb-3 ms-6"
            >
              <div class="d-flex align-center mb-1">
              ...
              <div class="ms-3">
                <v-chip
                  v-for="item in selectedClassInfo.startingEquipment"
            ...
            <!-- Equipment Choices -->
            <div
              v-if="selectedClassInfo.startingEquipmentOptions && selectedClassInfo.startingEquipmentOptions.length"
              class="mb-3 ms-6"
            >
              <div class="d-flex align-center mb-1">
              ...
              <div class="ms-3">
                <div
                  v-for="opt in selectedClassInfo.startingEquipmentOptions"
                  :key="'eqopt-' + (opt.desc || opt.choose || Math.random())"
                  class="mb-2"
                >
                  <template v-if="opt.from && Array.isArray(opt.from.options)">
                    <span
                      v-for="(choice, choiceIdx) in opt.from.options"
