        ...
        <v-card variant="outlined">
          ...
          <v-card-text class="pt-2 pb-3">
            <v-select
              ...
              item-title="name"
              item-value="id"
              :items="characterData?.backgroundData || []"
        ...
        >
            ...
            <div class="d-flex flex-column align-end">
              ...
              <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                <v-tooltip
                  ...
                  :key="'score-' + score"
                  location="top"
                  text="An ability score that's important for characters with this background"
                >
          ...
          <v-card-text class="pt-3 pb-2">
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                  <v-tooltip
                    ...
                    :key="'tool-' + tool"
                    location="top"
                    text="A tool or instrument your character learned to use in their background"
                  >
                    <template #activator="{ props }">
            ...
            >
              ...
              <div class="ms-3">
                <div style="display: flex; gap: 6px; flex-wrap: wrap; align-items: center;">
                  ...
                  <v-tooltip
                    v-for="option in selectedBackgroundInfo.languageOptions.from"
            ...
            >
              ...
              <div class="ms-3">
                <v-tooltip
                  v-for="item in selectedBackgroundInfo.startingEquipment"
