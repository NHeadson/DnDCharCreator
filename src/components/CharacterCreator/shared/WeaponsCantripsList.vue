  ...
  <v-card class="mb-6" variant="outlined">
    ...
    <v-card-text class="pt-3">
      ...
      <div class="mb-4">
            ...
            <v-card class="weapon-card" color="accent-lighten-5" flat>
              <v-card-text class="pa-3">
                <div class="d-flex justify-between align-center mb-2">
                  ...
                  <v-btn color="error" icon size="x-small" variant="text" @click="removeWeapon(index)">
                ...
                <v-row dense>
                  ...
                  <v-col cols="6">
                    <v-text-field v-model="weapon.damage" density="compact" label="Damage (e.g., 1d8)" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
                    <v-select v-model="weapon.damageType" density="compact" :items="damageTypes" label="Damage Type" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
                    <v-select v-model="weapon.attackBonus" density="compact" item-title="label" item-value="value" :items="abilityScores" label="Attack Bonus" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
        ...
        <v-btn class="mt-2" color="accent" prepend-icon="mdi-plus" variant="outlined" @click="addWeapon">Add Weapon</v-btn>
      </div>
      ...
      <div>
            ...
            <v-card class="cantrip-card" color="purple-lighten-5" flat>
              <v-card-text class="pa-3">
                <div class="d-flex justify-between align-center mb-2">
                  ...
                  <v-btn color="purple" icon size="x-small" variant="text" @click="removeCantrip(index)">
                    <v-icon size="small">mdi-close</v-icon>
                  </v-btn>
                </div>
                ...
                <v-row dense>
                  ...
                  <v-col cols="6">
                    <v-text-field v-model="cantrip.damage" density="compact" label="Damage (e.g., 1d10)" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
                    <v-select v-model="cantrip.damageType" density="compact" :items="damageTypes" label="Damage Type" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
                    <v-text-field v-model="cantrip.range" density="compact" label="Range" variant="outlined" />
                  </v-col>
                  <v-col cols="6">
                    <v-select v-model="cantrip.savingThrow" density="compact" :items="savingThrows" label="Saving Throw" variant="outlined" />
                  </v-col>
                </v-row>
              </v-card-text>
            </v-card>
        ...
        <v-btn class="mt-2" color="purple" prepend-icon="mdi-plus" variant="outlined" @click="addCantrip">Add Damage Cantrip</v-btn>
      </div>
    </v-card-text>
  </v-card>
</template>
...
// Saving throws
const savingThrows = ['None', 'Strength', 'Dexterity', 'Constitution', 'Intelligence', 'Wisdom', 'Charisma']
