<template>
  <v-card class="mb-6" variant="outlined">
    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" md="4">
          <v-select v-model="character.alignment" density="comfortable" hide-details :items="alignments"
            label="Alignment" variant="outlined" />
        </v-col>
        <v-col cols="12">
          <v-textarea v-model="character.appearance" class="mb-3" hide-details label="Physical Appearance" rows="3"
            variant="outlined" />
        </v-col>
        <v-col cols="12">
